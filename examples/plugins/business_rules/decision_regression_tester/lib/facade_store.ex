defmodule Examples.BusinessRules.DecisionRegressionTester.FacadeStore do
  @moduledoc """
  Agent-backed stash for the `BfwEngine.EngineFacade` received during `on_load/1`
  so the regression worker can reach wired `facade.decisions.*` closures from `on_ready/1`.
  """
