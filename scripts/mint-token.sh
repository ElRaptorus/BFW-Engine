...
#   BFE_JWT_HS256_SECRET=my-secret ./scripts/mint-token.sh
#
...
SECRET="${BFE_JWT_HS256_SECRET:-AveOmnissiah_FromTheHolyForgesOfMars_NotAProductionSecret_Mechanicus!!}"

NOW=$(date +%s)
EXP=$(( NOW + ${BFE_TOKEN_EXP_SECONDS:-86400} ))
