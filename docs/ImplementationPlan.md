...
compensations, engine_timers). There is no `pending_escalations` table
(escalation D1). Partitioned tables use monthly range partitions. LZ4 JSONB compression is applied
