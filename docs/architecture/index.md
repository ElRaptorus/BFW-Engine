...
- **[sdk-client.md](sdk-client.md)** — TypeScript SDK and client packages: package structure, dependency direction, error mapping pipeline, authentication, integration test architecture, CI/CD (Node.js 24.20)
