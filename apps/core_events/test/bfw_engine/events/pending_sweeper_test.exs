defmodule BfwEngine.Events.PendingSweeperTest do
  ...
  describe "sweep interval configuration" do
    test "uses BFE_PENDING_SWEEPER_INTERVAL from application env" do
      configure_mock_adapters(self())
  ...
  defp configure_mock_adapters(test_pid, opts \\ []) do
    ...
    Application.put_env(
      :core_events,
      :message_persistence_adapter,
      BfwEngine.Events.PendingSweeperTest.MockMessagePersistenceAdapter
    )

    Application.put_env(
      :core_events,
      :signal_persistence_adapter,
      BfwEngine.Events.PendingSweeperTest.MockSignalPersistenceAdapter
    )
  end
  ...
  defmodule MockSignalPersistenceAdapter do
    @moduledoc false
    @behaviour BfwEngine.Events.SignalPersistence
