defmodule BfwEngine.Events.SinkWorker do
  @moduledoc """
  GenServer wrapping a single registered `BfwEngine.Plugin.EventSink`.
  ...
  own worker, which is restarted by `BfwEngine.Events.SinkSupervisor`
