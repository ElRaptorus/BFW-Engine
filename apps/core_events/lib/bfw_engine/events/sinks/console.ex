defmodule BfwEngine.Events.Sinks.Console do
  ...
  defp event_severity(%BfwEngine.Types.Event.EngineShutdown{}), do: :warn
  defp event_severity(%BfwEngine.Types.Event.SinkFailed{}), do: :error
