defmodule BfwEngine.Types.Event do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.SinkFailed do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.EngineStarted do
...
defmodule BfwEngine.Types.Event.EngineShutdown do
...
defmodule BfwEngine.Types.Event.EngineOverloaded do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.EngineRecovered do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.PluginQuarantined do
...
defmodule BfwEngine.Types.Event.ProcessInstanceStateChanged do
...
defmodule BfwEngine.Types.Event.FlowNodeInstanceStarted do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.FlowNodeInstanceFinished do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.FlowNodeInstanceStateChanged do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.MultiInstanceStarted do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.MultiInstanceCompleted do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.UserTaskValidationFailed do
...
defmodule BfwEngine.Types.Event.PluginAsyncFlowNodeRehydrated do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.CallActivityChildStarted do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.SubProcessChildStarted do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.EventSubprocessTriggered do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.DataObjectWritten do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.ProcessDefinitionDeployed do
  @moduledoc """
  Emitted when one or more BPMN process versions are deployed.

  Published per deployed version from `BfwEngine.Api.persist_deploy_batch/3`.
...
defmodule BfwEngine.Types.Event.ProcessDefinitionUndeployed do
  @moduledoc """
  Emitted when a BPMN process version is soft-deleted.

  Published from `BfwEngine.Api.soft_delete_process_version/3`.
...
defmodule BfwEngine.Types.Event.ProcessDefinitionEnabled do
  @moduledoc """
  Emitted when a BPMN process definition is re-enabled.

  Published from `BfwEngine.Api.update_process_enabled/3`.
  """
...
defmodule BfwEngine.Types.Event.ProcessDefinitionDisabled do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.DecisionDefinitionDeployed do
  @moduledoc """
  Emitted when one or more DMN decision versions are deployed.

  Published per deployed version from `BfwEngine.Api.deploy_dmn_batch/3`.
  The `source` field distinguishes REST-initiated deploys from plugin-initiated ones.
  """
...
defmodule BfwEngine.Types.Event.DecisionDefinitionUndeployed do
  @moduledoc """
  Emitted when a DMN decision version is soft-deleted.

  Published from `BfwEngine.Api.soft_delete_decision_version/3`.
  The `source` field distinguishes REST-initiated deletes from plugin-initiated ones.
  """
...
defmodule BfwEngine.Types.Event.DecisionEvaluated do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.ProcessInstanceRetried do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.TimerFired do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.MessagePublished do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.MessageArrived do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.SignalPublished do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.SignalArrived do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.EscalationRaised do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.CompensationTriggered do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.TransactionCancelled do
  @moduledoc """
...
defmodule BfwEngine.Types.Event.AdHocActivityActivated do
...
defmodule BfwEngine.Types.Event.AdHocSubProcessCompleted do
...
defmodule BfwEngine.Types.Event.ActivityCompensated do
  @moduledoc """
