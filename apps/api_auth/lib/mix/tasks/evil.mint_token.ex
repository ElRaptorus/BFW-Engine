defmodule Mix.Tasks.Evil.MintToken do
  @moduledoc """
  ...
  ## Examples
      ...
      mix evil.mint_token --exp 7d

      # Token valid for 30 minutes
      mix evil.mint_token --exp 30m

      # Custom operator with 1-hour expiry
      mix evil.mint_token --sub operator-1 --roles admin,viewer --exp 1h
  ...
  @default_secret "BloodForTheBloodGod!_SkullsForTheSkullThrone!"
  ...
  defp print_usage do
    Mix.shell().error("""
    Usage: mix evil.mint_token [options]
    ...
    Run 'mix evil.mint_token --help' for full documentation.
    """)
  end
