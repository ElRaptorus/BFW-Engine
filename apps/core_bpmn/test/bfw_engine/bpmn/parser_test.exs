defmodule BfwEngine.BPMN.ParserTest do
  ...
  describe "parse/1 — multi-process with extensions" do
    ...
    test "script task with bfw:scriptRef parses ref as extension element", %{
      definitions: definitions
    } do
      [main | _] = definitions.processes
    ...
    test "bfw:valueContract on DataObject parses JSON Schema", %{definitions: definitions} do
      [main | _] = definitions.processes
      assert [do_obj] = main.data_objects
  ...
  describe "parse/1 — CallActivity bfw:startEventId" do
      ...
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
        ...
        <bpmn:process id="P1" name="Test" isExecutable="true">
          ...
          <bpmn:callActivity id="CA_1" calledElement="child-proc">
            <bpmn:extensionElements>
              <bfw:startEventId>Start_B</bfw:startEventId>
            </bpmn:extensionElements>
    ...
    test "ignores empty startEventId" do
      ...
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
        ...
        <bpmn:process id="P1" name="Test" isExecutable="true">
          ...
          <bpmn:callActivity id="CA_1" calledElement="child-proc">
            <bpmn:extensionElements>
              <bfw:startEventId>   </bfw:startEventId>
            </bpmn:extensionElements>
            <bpmn:incoming>F1</bpmn:incoming>
            <bpmn:outgoing>F2</bpmn:outgoing>
          </bpmn:callActivity>
  ...
  describe "parse/1 — CallActivity bfw:calledProcessVersion" do
  ...
  describe "parse/1 — direction-aware contracts on message events" do
    ...
    test "leftover bfw:payload and bfw:eventMapping XML is ignored" do
      xml = """
      <?xml version="1.0" encoding="UTF-8"?>
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
                        xmlns:bfw="https://bifrostforge.world/schema/bpmn" id="D1">
      ...
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
        ...
        <bpmn:process id="P1" isExecutable="true">
          ...
          <bpmn:startEvent id="Start_1">
            <bpmn:extensionElements>
              <bfw:resultContract>{"type":"object","required":["customerId"]}</bfw:resultContract>
            </bpmn:extensionElements>
            <bpmn:messageEventDefinition messageRef="Msg_1"/>
  ...
  describe "parse/1 — embedded subprocess" do
    ...
    test "subprocess shell captures bfw:inputMapping and bfw:outputMapping" do
      xml = """
      <?xml version="1.0" encoding="UTF-8"?>
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
                        xmlns:bfw="https://bifrostforge.world/schema/bpmn"
        ...
        <bpmn:process id="Process_1" isExecutable="true">
          ...
          <bpmn:subProcess id="SubProcess_1">
            <bpmn:extensionElements>
              ...
              <bfw:outputMapping source="result.status" target="status" />
            </bpmn:extensionElements>
            <bpmn:startEvent id="Sub_Start_1" />
          </bpmn:subProcess>
        </bpmn:process>
    ...
    test "subprocess shell captures bfw:payloadContract and bfw:resultContract" do
      xml = """
      <?xml version="1.0" encoding="UTF-8"?>
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
                        xmlns:bfw="https://bifrostforge.world/schema/bpmn"
  ...
  describe "parse/1 — parser_coverage_tasks_gateways.bpmn" do
    ...
    test "manual task maps bfw:requireConfirmation text to require_confirmation", %{
      process: process
    } do
    ...
    test "definitions-level bfw:LinterRulesetScore maps all Studio attributes", %{
      ...
      assert score.ruleset_id == "bfw-default"
  ...
  describe "parse/1 — parser_coverage_multi_instance.bpmn" do
    ...
    test "multi-instance maps bfw:inputCollection text to collection_expression", %{
      process: process
    } do
      user_task = find_node(process, "UT_MI")
    ...
    test "multi-instance maps bfw:elementVariable to element_variable", %{process: process} do
      user_task = find_node(process, "UT_MI")
  ...
  describe "parse/1 — parser_coverage_standard_loop.bpmn" do
    ...
    test "standard loop maps bfw:loopInterval extension", %{process: process} do
      script_task = find_node(process, "Script_Loop")
  ...
  describe "bpmn:adHocSubProcess parsing" do
    ...
    <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
      ...
      <bpmn:process id="Process_AH" isExecutable="true">
        ...
        <bpmn:adHocSubProcess id="AH_1" name="Toolbox" ordering="Sequential"
          ...
          <bpmn:extensionElements>
            <bfw:activeElements>["Task_A", "Task_B"]</bfw:activeElements>
          </bpmn:extensionElements>
    ...
    test "maps bfw:activeElements body to active_elements_expression" do
      {:ok, definitions} = Parser.parse(@adhoc_full_xml)
      [process] = definitions.processes
      adhoc_node = find_node(process, "AH_1")
    ...
    test "leaves active_elements_expression nil when bfw:activeElements absent" do
      xml = """
      <?xml version="1.0" encoding="UTF-8"?>
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
                        xmlns:bfw="https://bifrostforge.world/schema/bpmn"
    ...
    test "ad-hoc shell captures bfw:payloadContract and bfw:resultContract" do
      xml = """
      <?xml version="1.0" encoding="UTF-8"?>
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
                        xmlns:bfw="https://bifrostforge.world/schema/bpmn"
    ...
    test "ad-hoc shell captures bfw:inputMapping and bfw:outputMapping" do
      xml = """
      <?xml version="1.0" encoding="UTF-8"?>
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
                        xmlns:bfw="https://bifrostforge.world/schema/bpmn"
        ...
        <bpmn:process id="Process_AH_M" isExecutable="true">
          ...
          <bpmn:adHocSubProcess id="AH_M">
            <bpmn:extensionElements>
              <bfw:inputMapping source="token.orderId" target="orderId"/>
              <bfw:outputMapping source="result.summary" target="summary"/>
            </bpmn:extensionElements>
            <bpmn:task id="Task_1" name="Something"/>
          </bpmn:adHocSubProcess>
        </bpmn:process>
      ...
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
        ...
        <bpmn:process id="Process_AH_After" isExecutable="true">
          ...
          <bpmn:adHocSubProcess id="AH_After" ordering="Sequential" implementation="my-plugin">
            ...
            <bpmn:extensionElements>
              <bfw:activeElements>["Task_First"]</bfw:activeElements>
            </bpmn:extensionElements>
    ...
    test "bfw:activeElements on non-ad-hoc subprocess is silently ignored" do
      xml = """
      <?xml version="1.0" encoding="UTF-8"?>
      <bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"
                        xmlns:bfw="https://bifrostforge.world/schema/bpmn"
        ...
        <bpmn:process id="Process_AE_Ignore" isExecutable="true">
          ...
          <bpmn:subProcess id="SP_AE">
            <bpmn:extensionElements>
              <bfw:activeElements>["Task_1"]</bfw:activeElements>
            </bpmn:extensionElements>
