defmodule BfwEngine.BPMN.Parser.SaxHandler do
  @moduledoc """
  Saxy callback module that builds `BfwEngine.BPMN.Model.*` structs
  ...
  defp handle_end(
    ...
    obj =
      case {schema, text} do
        ...
        {nil, _unparseable} ->
          Logger.warning(
            "DataObject '#{obj.id}': bfw:valueContract contains unparseable JSON, ignoring"
          )
