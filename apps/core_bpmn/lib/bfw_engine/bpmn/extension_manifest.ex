defmodule BfwEngine.BPMN.ExtensionManifest do
  @moduledoc """
  Declarative registry of every `bfw:*` BPMN extension element the parser
  (`BfwEngine.BPMN.Parser.SaxHandler`) reads, plus enough metadata for a
  ...
  descriptor (`bfw-platform.json`, hand-written and Studio-owned per D-5)
  ...
  `mix bfw.gen.extension_manifest` serializes `build/0` to
  `extension-manifest.json`. A CI diff-guard (see the mix task and
  `apps/core_bpmn/test/bfw_engine/bpmn/extension_manifest_test.exs`)
  ...
  | Key | Meaning |
  |---|---|
  | `element` | The `bfw:*` element name as written in XML (e.g. `httpUrl`) |
