...
defmodule BfwEngine.BPMN.Model.EventDefinition.None do
  @moduledoc "Empty event definition for plain/untyped start and end events."
  @type t :: %__MODULE__{}
  defstruct []
end

defmodule BfwEngine.BPMN.Model.EventDefinition.Message do
  @moduledoc """
  Message event definition — carries `messageRef` and optional
  `correlation_retrieval_expression` from `bfw:*` extensions.
...
defmodule BfwEngine.BPMN.Model.EventDefinition.Signal do
...
defmodule BfwEngine.BPMN.Model.EventDefinition.Timer do
  @moduledoc """
...
defmodule BfwEngine.BPMN.Model.EventDefinition.Error do
  @moduledoc """
...
defmodule BfwEngine.BPMN.Model.EventDefinition.Escalation do
...
defmodule BfwEngine.BPMN.Model.EventDefinition.Conditional do
...
defmodule BfwEngine.BPMN.Model.EventDefinition.Compensation do
  @moduledoc """
...
defmodule BfwEngine.BPMN.Model.EventDefinition.Terminate do
  @moduledoc "Terminate event definition. Semantics are position-dependent."
  @type t :: %__MODULE__{}
  defstruct []
end

defmodule BfwEngine.BPMN.Model.EventDefinition.Cancel do
  @moduledoc "Cancel event definition. Only valid inside transaction subprocesses."
  @type t :: %__MODULE__{}
  defstruct []
end

defmodule BfwEngine.BPMN.Model.EventDefinition.Link do
...
defmodule BfwEngine.BPMN.Model.FlowNodeData.StartEvent do
  @moduledoc """
...
defmodule BfwEngine.BPMN.Model.FlowNodeData.EndEvent do
  @moduledoc """
  ...
  alias BfwEngine.BPMN.Model.{EventDefinition, Mapping}
...
defmodule BfwEngine.BPMN.Model.FlowNodeData.IntermediateCatchEvent do
  @moduledoc """
...
defmodule BfwEngine.BPMN.Model.FlowNodeData.IntermediateThrowEvent do
  @moduledoc """
...
defmodule BfwEngine.BPMN.Model.FlowNodeData.BoundaryEvent do
  @moduledoc """
