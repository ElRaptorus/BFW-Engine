defmodule BfwEngine.Execution.TimerBoundaryIntegrationTest do
  @moduledoc """
  ...
  defp start_pi(definitions, payload) do
    ...
    {:ok, pid} =
      DynamicSupervisor.start_child(BfwEngine.Execution.Supervisor, {ProcessInstance, opts})
