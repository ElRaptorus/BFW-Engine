defmodule BfwEngine.Execution.SequenceFlowResolver do
  @moduledoc """
  ...
  def resolve(%FlowNode{} = completed_node, %BpmnProcess{} = process) do
    ...
    cond do
      ...
      not is_end_event and outgoing_count == 0 and not completed_node.is_for_compensation and
          not process.is_ad_hoc_scope ->
        {:error, :dead_end,
         %{
           flow_node_id: completed_node.id,
           flow_node_type: completed_node.type
