defmodule BfwEngine.Execution.Persistence do
  @moduledoc """
  ...
  @callback finish_fni_with_data_objects(
              fni_id :: String.t(),
              fni_changes :: map(),
              write_intents :: [BfwEngine.Execution.DataObjectWriteIntent.t()]
...
defmodule BfwEngine.Execution.Persistence.NoOp do
