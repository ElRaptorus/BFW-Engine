defmodule BfwEngine.Execution.ProcessInstance.State do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          event_subprocess_triggers: %{
            String.t() => BfwEngine.Execution.EventSubprocessTrigger.t()
          },
  ...
  defstruct [
    ...
    :notify_pid,
    mode: BfwEngine.Execution.ProcessInstance.StandardMode,
