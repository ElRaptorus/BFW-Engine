defmodule EvilEngine.Execution.FlowNodes.MessageEventHelper do
  @moduledoc """
  ...
  @doc """
  Evaluate the process-level `<evil:correlationKey>` FEEL expression
  ...
  @doc """
  Evaluate the `<evil:correlationRetrievalExpression>` from an event definition
