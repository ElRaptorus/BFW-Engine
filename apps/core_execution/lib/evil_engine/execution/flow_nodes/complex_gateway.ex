defmodule EvilEngine.Execution.FlowNodes.ComplexGateway do
  @moduledoc """
  Handler for `<bpmn:complexGateway>`.

  ThomasTheDaemonEngine implements the Complex Gateway as an opinionated,
  ...
  `EvilEngine.Execution.ComplexJoinEvaluator`:
