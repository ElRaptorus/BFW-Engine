defmodule EvilEngine.Execution.ProcessInstance.StandardMode do
  @moduledoc """
  ...
  @behaviour EvilEngine.Execution.ProcessInstance.Mode

  alias EvilEngine.BPMN.Model.FlowNode
  alias EvilEngine.BPMN.Model.Process, as: BpmnProcess
  alias EvilEngine.Execution.ProcessInstance.StartEventResolver
