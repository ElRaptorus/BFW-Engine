defmodule BfwEngine.Timers.Scheduler do
  @moduledoc """
  ...
  @default_primary_table :bfw_engine_timers_primary
  @default_target_index_table :bfw_engine_timers_target_index
