defmodule BfwEngine.DMN.EvaluatorTest do
    ...
    test "runtime evaluation rejects informationRequirement referencing unknown InputData" do
      ...
      broken_decision = %{
        ...
        | information_requirements: [
            %BfwEngine.DMN.Model.InformationRequirement{
              id: "ir_missing_input",
        ...
        decisions: [
          %Decision{
            ...
            knowledge_requirements: [
              %BfwEngine.DMN.Model.KnowledgeRequirement{required_knowledge_id: "BKM_multiply"}
            ],
  ...
  describe "max import depth guard" do
    ...
    test "imported BKM auto-invocation via knowledgeRequirement" do
      ...
      helpers_namespace = "https://bifrostforge.world/test/bkm-helper"
