defmodule EvilEngine.DMN.ParserTest do
  @moduledoc false
  ...
  describe "parse/1 — boxed context" do
    test "parses boxed context with 3 entries" do
      ...
      [decision] = definitions.decisions
      assert %EvilEngine.DMN.Model.BoxedContext{} = decision.expression
    ...
    test "parses nested context" do
      ...
      assert %EvilEngine.DMN.Model.BoxedContext{} = outer_entry1.expression
  ...
  describe "parse/1 — boxed list" do
    test "parses boxed list with 3 elements" do
      ...
      [decision] = definitions.decisions
      assert %EvilEngine.DMN.Model.BoxedList{} = decision.expression
  ...
  describe "parse/1 — relation" do
    test "parses relation with 2 columns and 2 rows" do
      ...
      [decision] = definitions.decisions
      assert %EvilEngine.DMN.Model.Relation{} = decision.expression
  ...
  describe "parse/1 — boxed conditional" do
    test "parses boxed conditional with if/then/else" do
      ...
      [decision] = definitions.decisions
      assert %EvilEngine.DMN.Model.BoxedConditional{} = decision.expression
  ...
  describe "parse/1 — boxed iterators" do
    test "parses boxed for" do
      ...
      assert %EvilEngine.DMN.Model.BoxedFor{} = for_decision.expression
    ...
    test "parses boxed every" do
      ...
      assert %EvilEngine.DMN.Model.BoxedEvery{} = every_decision.expression
    ...
    test "parses boxed some" do
      ...
      assert %EvilEngine.DMN.Model.BoxedSome{} = some_decision.expression
