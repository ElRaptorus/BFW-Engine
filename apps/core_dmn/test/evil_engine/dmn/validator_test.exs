defmodule EvilEngine.DMN.ValidatorTest do
  @moduledoc false
      ...
      definitions =
        minimal_definitions(
          decisions: [
            %Decision{
              id: "D1",
              expression: %EvilEngine.DMN.Model.BoxedContext{id: "ctx", context_entries: []}
            }
          ]
        )
      ...
      definitions =
        minimal_definitions(
          decisions: [
            %Decision{
              id: "D1",
              expression: %EvilEngine.DMN.Model.BoxedContext{
                id: "ctx",
                context_entries: [
                  %EvilEngine.DMN.Model.ContextEntry{
      ...
      definitions =
        minimal_definitions(
          decisions: [
            %Decision{
              id: "D1",
              expression: %EvilEngine.DMN.Model.BoxedList{id: "list", elements: []}
            }
          ]
        )
