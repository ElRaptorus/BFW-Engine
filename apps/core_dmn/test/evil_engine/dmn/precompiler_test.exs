defmodule EvilEngine.DMN.PrecompilerTest do
  @moduledoc false
  ...
  describe "precompile/1" do
    ...
    test "precompiles boxed context entries recursively" do
      ...
      assert %EvilEngine.DMN.Model.BoxedContext{} = context
    ...
    test "precompiles boxed list elements recursively" do
      ...
      assert %EvilEngine.DMN.Model.BoxedList{} = list
    ...
    test "precompiles relation row cells recursively" do
      ...
      assert %EvilEngine.DMN.Model.Relation{} = relation
    ...
    test "precompiles boxed conditional branches" do
      ...
      assert %EvilEngine.DMN.Model.BoxedConditional{} = conditional
