defmodule EvilEngine.DMN.Evaluator do
  @moduledoc """
  ...
  alias EvilEngine.DMN.Evaluator.BoxedExpressionEvaluator
  alias EvilEngine.DMN.Evaluator.DecisionServiceEvaluator
