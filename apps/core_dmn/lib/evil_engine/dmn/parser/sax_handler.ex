defmodule EvilEngine.DMN.Parser.SaxHandler do
  @moduledoc """
  Saxy callback module that builds `EvilEngine.DMN.Model.*` structs
  from SAX events.
  ...
  alias EvilEngine.DMN.Parser.SaxHandler.BoxedExpressions
