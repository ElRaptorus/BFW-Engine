defmodule BfwEngine.DMN.ModelCache do
  ...
  @table :bfw_engine_dmn_model_cache
  @namespace_index :bfw_engine_dmn_namespace_index
      ...
      {mod, fun} ->
        case apply(mod, fun, [id]) do
          {:ok, xml} when is_binary(xml) ->
            BfwEngine.DMN.parse_and_validate(xml)
