defmodule BfwEngine.DMN.EvaluationTrace do
  @moduledoc """
  ...
  defmodule ImportTrace do
    ...
    alias BfwEngine.DMN.EvaluationTrace, as: ParentTrace
  ...
  defmodule DecisionTrace do
    ...
    alias BfwEngine.DMN.EvaluationTrace.InputTrace
    alias BfwEngine.DMN.EvaluationTrace.RuleTrace
  ...
  defmodule RuleTrace do
    ...
    alias BfwEngine.DMN.EvaluationTrace.InputEntryTrace
