defmodule BfwEngine.Telemetry.SinkTest do
  use ExUnit.Case, async: true

  alias BfwEngine.Telemetry.Sink
  ...
  describe "handle_event/2" do
    test "emits telemetry event with event_type metadata and returns {:ok, state}" do
      ...
      ref = :telemetry_test.attach_event_handlers(self(), [[:bfw_engine, :event_bus]])
      ...
      assert_receive {[:bfw_engine, :event_bus], ^ref, %{count: 1},
