defmodule BfwEngine.Telemetry.DbQueryHandler do
  ...
  @handler_id "bfw-engine-db-query-handler"
  ...
  defp known_repos do
    ...
    if Code.ensure_loaded?(BfwEngine.Persistence.ReadRepo) do
