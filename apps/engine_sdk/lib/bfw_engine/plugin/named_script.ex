defmodule BfwEngine.Plugin.NamedScript do
  @moduledoc """
  Behaviour for plugin-provided script handlers dispatched via `bfw:scriptRef`.
  ...
  `script_key` that matches the `bfw:scriptRef` value in BPMN XML
  ...
  `<bfw:scriptRef>my_validation</bfw:scriptRef>`, it looks up the
