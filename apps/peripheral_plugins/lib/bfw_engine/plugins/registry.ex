defmodule BfwEngine.Plugins.Registry do
  @moduledoc """
  ...
  Each plugin capability has a conflict rule (see `BfwEngine.Plugin`):
  ...
  @capability_behaviours %{
    service_task_handler: BfwEngine.Plugin.ServiceTaskHandler,
    named_script: BfwEngine.Plugin.NamedScript,
    event_sink: BfwEngine.Plugin.EventSink,
    rest_api_extension: BfwEngine.Plugin.RestApiExtension,
    auth_provider: BfwEngine.Plugin.AuthProvider
  }
