example_root =
  Path.expand(
    "../../../../examples/plugins/service_task_handlers/python_script",
    __DIR__
  )

shared_sandbox_path =
  Path.expand("../../../../examples/plugins/shared/script_sandbox.ex", __DIR__)

Code.require_file(Path.expand("../../../../examples/plugins/shared/example_compiler.ex", __DIR__))
Code.require_file(shared_sandbox_path)
