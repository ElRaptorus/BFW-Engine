defmodule EvilEngine.Plugins.RegistryDispatchTest do
  use ExUnit.Case, async: false

  alias EvilEngine.Plugins.Registry
  alias EvilEngine.Plugins.RegistryDispatch
  ...
  describe "lookup_handler/1" do
    test "returns {:ok, module} when a service_task_handler matches implementation" do
      ...
      handler_module = EvilEngine.Plugins.Builtin.HttpServiceTaskHandler
