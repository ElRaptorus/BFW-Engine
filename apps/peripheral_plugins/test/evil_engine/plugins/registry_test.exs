defmodule EvilEngine.Plugins.RegistryTest.ValidServiceTaskHandler do
  @moduledoc false
...
defmodule EvilEngine.Plugins.RegistryTest.InvalidHandler do
  @moduledoc false
end

defmodule EvilEngine.Plugins.RegistryTest do
  use ExUnit.Case, async: false

  alias EvilEngine.Plugins.Registry

  @valid_handler EvilEngine.Plugins.RegistryTest.ValidServiceTaskHandler
  @invalid_handler EvilEngine.Plugins.RegistryTest.InvalidHandler
