defmodule BfwEngineWeb.Http.Plugs.RateLimitPlugTest do
  use ExUnit.Case, async: false

  import Plug.Test

  alias BfwEngineWeb.Http.Plugs.RateLimitPlug

  setup do
    if :ets.whereis(:bfw_engine_rate_limit) != :undefined do
      :ets.delete(:bfw_engine_rate_limit)
    end
