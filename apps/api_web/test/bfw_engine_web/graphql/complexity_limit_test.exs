defmodule BfwEngineWeb.Graphql.ComplexityLimitTest do
  @moduledoc """
  ...
  alias BfwEngineWeb.Graphql.PipelineModifier
  ...
  describe "Studio debugger dataObjectValues snapshot" do
    ...
    test "the configured default cap covers the debugger snapshot score" do
      ...
      assert cap >= complexity,
             "BFE_GRAPHQL_MAX_COMPLEXITY (#{cap}) is below the debugger snapshot score (#{complexity})"
    end
