defmodule BfwEngineWeb.Http.PlaygroundController do
  @moduledoc """
  ...
  <head>
    ...
    <title>GraphQL Playground — Bifrost Forge World Engine</title>
    <link rel="stylesheet"
  ...
  <body>
    <div id="auth-bar">
      ...
      <input id="token-input" type="text"
             placeholder="paste token from: mix bfw.mint_token" />
