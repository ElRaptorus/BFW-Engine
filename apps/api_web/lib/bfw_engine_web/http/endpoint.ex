defmodule BfwEngineWeb.Http.Endpoint do
  @moduledoc """
  ...
  socket "/socket", BfwEngineWeb.Ws.UserSocket,
    websocket: true,
    longpoll: false

  plug Plug.RequestId
  plug Plug.Telemetry, event_prefix: [:bfw_engine, :http]
