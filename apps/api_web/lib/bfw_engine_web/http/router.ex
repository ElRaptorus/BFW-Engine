defmodule BfwEngineWeb.Http.Router do
  @moduledoc """
  ...
  pipeline :api do
    plug :accepts, ["json"]
    plug BfwEngineWeb.Http.Plugs.SecurityHeadersPlug
  end
  ...
  pipeline :graphql_context do
    plug BfwEngineWeb.Http.Plugs.AbsintheContext
  end
  ...
  scope "/api" do
    ...
    get "/openapi", BfwEngineWeb.Http.OpenApiController, :spec
  end
  ...
  scope "/api/v1" do
    ...
    forward "/graphql", Absinthe.Plug,
      schema: BfwEngineWeb.Graphql.Schema,
      analyze_complexity: true,
      max_complexity: Application.compile_env(:api_web, :graphql_max_complexity, 10_000),
      pipeline: {BfwEngineWeb.Graphql.PipelineModifier, :pipeline}
  end

  scope "/admin", BfwEngineWeb.Http do
