defmodule BfwEngineWeb.Http.Plugs.AshActorPlug do
  @moduledoc """
  ...
  `BfwEngine.Auth.Plug`) and calls `Ash.PlugHelpers.set_actor/2` with the
  ...
  `BfwEngine.Api` facade migration — will allow all REST calls to be policy-
  ...
  Must be placed **after** `BfwEngine.Auth.Plug` in the pipeline so that
  ...
  alias BfwEngineWeb.Http.Plugs.AbsintheContext
