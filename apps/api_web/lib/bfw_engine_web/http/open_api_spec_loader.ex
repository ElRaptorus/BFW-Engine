defmodule BfwEngineWeb.Http.OpenApiSpecLoader do
  @moduledoc """
  ...
  load time from the Phoenix endpoint's HTTP port (`BFE_HTTP_PORT`).
  """
  ...
  defp runtime_http_port do
    endpoint_config = Application.get_env(:api_web, BfwEngineWeb.Http.Endpoint, [])
