defmodule Mix.Tasks.Bfw.Retention.Purge do
  @moduledoc """
  Hard-delete aged terminal process-instance trees per `BFE_RETENTION_*_DAYS`.
  ...
  `BfwEngine.Persistence.Release.purge_retention/0`.
  """
  ...
  def run(args) do
    ...
    if ProcessInstancePurge.any_days_policy?(retention_config) do
      ...
      Mix.shell().info("No BFE_RETENTION_*_DAYS configured; nothing to purge")
    end
  end
