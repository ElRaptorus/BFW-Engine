defmodule BfwEngine.Persistence.TimerStartScheduleAdapter do
  @moduledoc """
  Postgres implementation of `BfwEngine.Timers.Persistence`.
  ...
  `BfwEngine.Timers.Persistence.NoOp`; umbrella integration tests
  switch to this adapter via `ExecutionCase`.
  """

  @behaviour BfwEngine.Timers.Persistence

  alias BfwEngine.Execution.PersistenceRetry
  alias BfwEngine.Persistence.Resources.TimerStartSchedule
