defmodule BfwEngine.Persistence.Partitions do
  @moduledoc """
  ...
  `BFE_PARTITION_INTERVAL` (monthly, quarterly, half_yearly, yearly).
  ...
  def ensure_partitions do
    ...
    if interval == :off do
      Logger.info("Partitioning disabled (BFE_PARTITION_INTERVAL=off)")
      {:ok, 0}
    else
