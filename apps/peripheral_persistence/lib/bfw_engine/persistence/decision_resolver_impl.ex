defmodule BfwEngine.Persistence.DecisionResolverImpl do
  @moduledoc """
  Ash-backed implementation of `BfwEngine.Execution.DecisionResolver`.
  ...
  alias BfwEngine.Persistence.Resources.DecisionDefinition
  alias BfwEngine.Persistence.Resources.DecisionVersion
