defmodule BfwEngine.Persistence.Release do
  @moduledoc """
  ...
  `BFE_PARTITION_AHEAD_MONTHS` into the future.

  The partition interval is controlled by `BFE_PARTITION_INTERVAL`
