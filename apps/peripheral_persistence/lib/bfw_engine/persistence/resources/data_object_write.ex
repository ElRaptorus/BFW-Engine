defmodule BfwEngine.Persistence.Resources.DataObjectWrite do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :value, BfwEngine.Persistence.Types.JsonbAny, allow_nil?: false, public?: true
    attribute :created_at, :utc_datetime_usec, allow_nil?: false, public?: true
  end

  relationships do
    belongs_to :process_instance, BfwEngine.Persistence.Resources.ProcessInstance do
