defmodule BfwEngine.Persistence.Resources.ProcessVersion do
  @moduledoc """
  ...
  relationships do
    belongs_to :process, BfwEngine.Persistence.Resources.Process do
      attribute_writable? true
      define_attribute? false
    end

    has_many :process_instances, BfwEngine.Persistence.Resources.ProcessInstance do
