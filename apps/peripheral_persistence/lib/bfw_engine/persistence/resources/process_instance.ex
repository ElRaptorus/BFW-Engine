defmodule BfwEngine.Persistence.Resources.ProcessInstance do
  @moduledoc """
  ...
  policies do
    ...
    bypass action_type(:read) do
      authorize_if {BfwEngine.Persistence.Checks.ZeekyBoogieDoog, []}
      authorize_if {BfwEngine.Persistence.Checks.ObserveAll, []}
    end
  ...
  relationships do
    belongs_to :process_version, BfwEngine.Persistence.Resources.ProcessVersion do
      attribute_writable? true
      define_attribute? false
      public? true
    end

    has_many :flow_node_instances, BfwEngine.Persistence.Resources.FlowNodeInstance do
      destination_attribute :process_instance_id
      public? true
    end

    has_many :data_object_values, BfwEngine.Persistence.Resources.DataObject do
      destination_attribute :process_instance_id
      public? true
    end

    has_many :data_object_history, BfwEngine.Persistence.Resources.DataObjectWrite do
      destination_attribute :process_instance_id
      public? true
    end
  end
  ...
  calculations do
    calculate :final_tokens, {:array, :map}, BfwEngine.Persistence.Calculations.FinalTokens do
      public? true
