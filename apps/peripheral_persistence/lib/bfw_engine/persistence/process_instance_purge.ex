defmodule BfwEngine.Persistence.ProcessInstancePurge do
  @moduledoc """
  ...
  Used by `mix bfw.retention.purge` and by retry cascade in
  ...
  Used by `mix bfw.retention.purge` to print the no-op message without
