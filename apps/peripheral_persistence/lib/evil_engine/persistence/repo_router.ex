defmodule EvilEngine.Persistence.RepoRouter do
  @moduledoc """
  ...
  @read_repo if Mix.env() == :test,
               do: EvilEngine.Persistence.Repo,
               else: EvilEngine.Persistence.ReadRepo

  @spec repo(Ash.Resource.t(), :read | :mutate) :: module()
  def repo(_resource, :read), do: @read_repo
  def repo(_resource, :mutate), do: EvilEngine.Persistence.Repo
end
