defmodule BfwEngine.Persistence.SignalPersistenceAdapterTest do
  @moduledoc """
  Specification-driven tests for `BfwEngine.Persistence.SignalPersistenceAdapter`.
  ...
  alias BfwEngine.Persistence.Resources.PendingSignal
  alias BfwEngine.Persistence.Resources.Signal
  alias BfwEngine.Persistence.SignalPersistenceAdapter
