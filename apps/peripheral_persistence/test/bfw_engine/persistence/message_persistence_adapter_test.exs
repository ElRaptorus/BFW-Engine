defmodule BfwEngine.Persistence.MessagePersistenceAdapterTest do
  @moduledoc """
  Specification-driven tests for `BfwEngine.Persistence.MessagePersistenceAdapter`.
  ...
  alias BfwEngine.Persistence.MessagePersistenceAdapter
