...
already_owner? =
  case Ecto.Adapters.SQL.Sandbox.checkout(BfwEngine.Persistence.Repo) do
    :ok -> false
    {:already, :owner} -> true
  end
...
for table <-
  ...
  BfwEngine.Persistence.Repo.query!("TRUNCATE #{table} CASCADE")
end

unless already_owner?, do: Ecto.Adapters.SQL.Sandbox.checkin(BfwEngine.Persistence.Repo)
